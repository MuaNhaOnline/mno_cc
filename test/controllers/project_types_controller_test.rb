...
class ProjectTypesControllerTest < ActionController::TestCase
  ...
  test "should create project_type" do
    assert_difference('ProjectType.count') do
      post :create, project_type: { code: @project_type.code, name: @project_type.name, options: @project_type.options, order: @project_type.order }
    end
  ...
  test "should update project_type" do
    patch :update, id: @project_type, project_type: { code: @project_type.code, name: @project_type.name, options: @project_type.options, order: @project_type.order }
    assert_redirected_to project_type_path(assigns(:project_type))
  end
