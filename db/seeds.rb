...
RealEstateType.create [
	...
	{ name: 'high_apartment', code: '|high_apartment|apartment|complex_apartment|', options: '{"group":"apartment","html":{"attributes":"data-on=apartment data-off=un-apartment"}}' },
	{ name: 'medium_apartment', code: '|medium_apartment|apartment|complex_apartment|', options: '{"group":"apartment","html":{"attributes":"data-on=apartment data-off=un-apartment"}}' },
	{ name: 'low_apartment', code: '|low_apartment|apartment|complex_apartment|', options: '{"group":"apartment","html":{"attributes":"data-on=apartment data-off=un-apartment"}}' },
